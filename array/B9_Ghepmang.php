...
<body>
    ...
    <?php 
     ...
     if (isset($_POST['mangA'])) $mangA = $_POST['mangA'];else $mangA = "";$strA = "";
     if (isset($_POST['mangB'])) $mangB = $_POST['mangA'];else $mangB = "";$strB = "";
     if (isset($_POST['mtd'])) $mtd = $_POST['mtd'];else $mtd = "";
     if (isset($_POST['mgd'])) $mgd = $_POST['mgd'];else $mgd = "";
     if (isset($_POST['mdg'])) $mdg = $_POST['mdg'];else $mdg = "";
     if (isset($_POST['mgd'])) $mgd = $_POST['mgd'];else $mgd = "";
     if (isset($_POST['countA'])) $countA = $_POST['countA'];else $countA = "";
     if (isset($_POST['countB'])) $countB = $_POST['countB'];else $countB = "";
